...
abstract class QuoteRepository{
  ...
  Future<Either<FirebaseException,AuthorCollection>> getAuthorQuotes(int userId);
  //gets all custom user collection
  Future<Either<FirebaseException,UserCollection>> getUserCollections(int userId);
